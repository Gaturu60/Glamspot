...
from models import User, Stylist, Service, Booking  # Ensure Booking replaces Appointment
...
class StylistResource(Resource):
    def get(self):
        ...
        stylist_list = [{"id": stylist.id, "name": stylist.name, "specialty": stylist.specialty} for stylist in stylists]
